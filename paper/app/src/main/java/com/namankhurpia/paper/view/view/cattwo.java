...
public class cattwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cattwo);
    ...
    private Object getpapers() {
        ...
        progressDoalog = new ProgressDialog(cattwo.this);
        ...
        Call<List<Schema>> call = paperDataService.GetCattwo();
    ...
    private void viewData() {
        recyclerView = (RecyclerView) findViewById(R.id.recyclerview_cattwo);

        //changed
        paperadapter = new subject_adapter_recyclerview(getApplicationContext(), data);
        //ended with get app context

        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(cattwo.this);
