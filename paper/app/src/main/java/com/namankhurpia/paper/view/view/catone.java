...
public class catone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catone);
    ...
    private Object getpapers() {
        ...
        progressDoalog = new ProgressDialog(catone.this);
        ...
        Call<List<Schema>> call = paperDataService.GetCatone();
    ...
    private void viewData() {
        recyclerView=(RecyclerView)findViewById(R.id.recyclerview_catone);

        //changed
        paperadapter=new subject_adapter_recyclerview(getApplicationContext(),data);
        //ended with get app context

        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(catone.this);
